...
<body class="bg-gradient-to-r from-gray-800 to-gray-900 min-h-screen flex items-center justify-center">
    <div class="bg-gray-800 rounded-xl shadow-lg p-8 max-w-md w-full mx-4">
        <h1 class="text-3xl font-bold mb-4 text-white text-center">Account Suspended</h1>
        <p class="text-gray-400 text-center mb-8">Your account has been suspended. Please contact support for more information. If you are a teacher, please wait until the admin approves your account.</p>
        <div class="flex flex-col space-y-4">
            ...
            <a href="index.php?action=returnHome" class="group relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-lg shadow-2xl bg-gradient-to-br from-teal-500 to-green-500 hover:from-teal-400 hover:to-green-400 transition-all duration-300 ease-out">
                ...
                <span class="relative group-hover:scale-110 transition-transform duration-300">Return Home</span>
            </a>
        </div>
    </div>
</body>
