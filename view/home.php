    ...
    <main class="container mx-auto px-6 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl overflow-hidden transform hover:scale-105 transition duration-300">
                <img src="https://img-c.udemycdn.com/course/240x135/5456998_368f_5.jpg" alt="Course Image" class="w-full h-48 object-cover">
                <div class="p-6">
                    <h2 class="text-2xl font-semibold mb-4 text-white">Introduction to Web Development</h2>
                    <p class="text-gray-400 mb-6">Learn the basics of HTML, CSS, and JavaScript.</p>
                    <div class="flex justify-between items-center">
                        <span class="text-purple-400 font-bold text-xl">$49.99</span>
                        <a href="?action=CourseDetails" class="bg-purple-600 text-white px-6 py-2 rounded-full shadow-md hover:bg-purple-700 hover:shadow-lg transition duration-300">View Details</a>
                    </div>
                </div>
            </div>
        </div>
